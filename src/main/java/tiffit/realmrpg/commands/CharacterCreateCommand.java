        ...
        if (empty_slots == 0) {
            ...
            if (args.length >= 1) {
                ...
                try {
                    ...
                    data.chars.add(new Character(clss, 0, 0, 0, 0, 0, new int[] {0, 0, 0, 0, 0, 0, 0, 0},
                    		clss.LIFE_START, clss.MANA_START, clss.ATT_START, clss.DEF_START,
                    		clss.SPD_START, clss.DEX_START, clss.VIT_START, clss.WIS_START));
                    data.save();
